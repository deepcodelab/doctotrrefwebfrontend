...
const Dashboard: React.FC = () => {
  ...
  const stats = isDoctor
    ...
    : [
        ...
        {
          title: "Emergency",
          value: profile?.emergency_contact ?? "N/A",
          icon: (
  ...
  return (
    <div
      key={user?.id}
      className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-100 p-6 md:p-12 relative"
    >
      {/* HEADER */}
      <motion.header
        initial={{ opacity: 0, y: -40 }}
